...
namespace UnityMovementAI
{
    ...
    public class LinePath
    {
        ...
        public LinePath(Transform[] nodes)
        {
            this.nodes = nodes;
        ...
        public void Draw()
        {
            ...
            {
                Debug.DrawLine(nodes[i].position, nodes[i + 1].position, Color.cyan, 0.0f, false);
            }
        }
        ...
        public float GetParam(Vector3 position, MovementAIRigidbody rb)
        {
            ...
            float param = this.distances[closestSegment] + GetParamForSegment(position, nodes[closestSegment].position, nodes[closestSegment + 1].position, rb);
        ...
        public int GetClosestSegment(Vector3 position)
        {
            ...
            float closestDist = DistToSegment(position, nodes[0].position, nodes[1].position);
