...
namespace UnityMovementAI
{
    ...
    public class WallAvoidance : MonoBehaviour
    {
        ...
        /// </summary>
        public float wallAvoidDistance = 0.5f; // -> 2f

        /// <summary>
        /// How far ahead the ray should extend
        /// </summary>
        public float mainWhiskerLen = 1.25f; // -> 10f

        public float sideWhiskerLen = 0.701f; // -> 8f
        ...
        bool FindObstacle(Vector3 facingDir, out GenericCastHit firstHit)
        {
            ...
            float orientation = SteeringBehaviour.VectorToOrientation(facingDir, rb.is3D);

            dirs[1] = SteeringBehaviour.OrientationToVector(orientation + sideWhiskerAngle * Mathf.Deg2Rad, rb.is3D);
            dirs[2] = SteeringBehaviour.OrientationToVector(orientation - sideWhiskerAngle * Mathf.Deg2Rad, rb.is3D);
